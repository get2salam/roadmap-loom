  ...
  "slug": "roadmap-loom",
  "title": "Roadmap Loom",
  "tagline": "Weave initiatives into a visible roadmap without losing the story between them.",
  "domainLabel": "initiatives",
  "itemLabel": "initiative",
  "emptyTitle": "No initiatives yet",
  "emptyBody": "Add the initiatives shaping the next chapter.",
  "seedTitle": "Quarter roadmap loom",
  "seedSubtitle": "A narrative-first roadmap board for focused teams and solo builders.",
  "categories": [
    "Now",
    "Next",
    "Later",
  ...
  "items": [
    {
      ...
      "score": 10,
      "effort": 3,
      "note": "Everything downstream gets easier when the promise is crisp."
    },
    {
      "title": "Build a proof-rich demo",
      "category": "Next",
      "state": "Shaping",
      "score": 9,
      "effort": 5,
      "note": "The best sales asset is often a short demo with visible outcomes."
    },
    {
      "title": "Explore partner distribution",
      "category": "Later",
      "state": "Exploration",
      "score": 7,
      "effort": 4,
      "note": "Interesting but still secondary to nailing the first funnel."
    }
  ]
};
